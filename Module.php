 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'aadutskevich\admin\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@aadutskevich/admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (!isset(Yii::$app->i18n->translations['rbac-admin'])) {
            Yii::$app->i18n->translations['rbac-admin'] = [
                ...
                'sourceLanguage' => 'en',
                'basePath' => '@aadutskevich/admin/messages'
            ];
        }
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('aadutskevich\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
